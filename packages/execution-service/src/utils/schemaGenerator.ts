 ...
 * Simple implementation that prioritizes performance and simplicity
 */

// JSON Schema 7 type definition (subset we need)
 ...
 * Extracts the json field and generates schema from it
 * 
 * @param nodeData - NodeData object with json field
 * @returns JSONSchema7 schema
 */
export function generateSchemaFromNodeData(nodeData: any): JSONSchema7 {
	// Use json field
	const data = nodeData?.json ?? nodeData;
